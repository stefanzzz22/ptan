...
from lib import dqn_model, common, config

STATES_TO_EVALUATE = 1000
EVAL_EVERY_FRAME = 100

params_save_file = "saved_models/model-ddqn"
...
def calc_loss(batch, net, tgt_net, gamma, cuda=False, double=True):
    ...
    return nn.SmoothL1Loss(size_average=False)(state_action_values, expected_state_action_values)
